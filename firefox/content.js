// Content script for Share on Bluesky extension (Firefox - Manifest V2)
// Compatible with Firefox's content script format
...
function getPageDescription() {
  ...
  // Final fallback - try to extract from first paragraph
